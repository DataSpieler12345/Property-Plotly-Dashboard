...
from helpers import avg_price_map_figure, avg_price_bar_figure
...
def update_plots(selected_region, selected_year):
    fig1 = avg_price_map_figure(selected_region, selected_year)
    fig2 = avg_price_bar_figure(selected_region, selected_year)
    return fig1, fig2
